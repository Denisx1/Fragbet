...
import { ICountyDetails } from "../../interfaces/teamInterfaces";
...
export const initTeam = (sequelize: Sequelize) => {
  Team.init(
    ...
    {
      sequelize,
      tableName: "teams", // Убедись, что таблица называется "teams"
      timestamps: false, // Если не нужно отслеживать создание/обновление
    }
  );
};
